...
IComponent::IComponent():width(0), hight(0){}

IComponent::IComponent(int width, int hight, BorderType border) : Control(0, 0, border), width(width), hight(hight), visibility(true){}
